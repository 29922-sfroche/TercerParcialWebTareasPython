...
class Vehiculo:
    ...
    def get_form(self, id=None):
        ...
        # ------------------------------------------
        # CONSTRUCCIÓN HTML DEL FORMULARIO
        # ------------------------------------------
        if bandera:
    ...
    def get_list(self):
        ...
        if rows:
            for row in rows:
                ...
                #Imprimir la variable row para ver su contenido
                html += "<br>VARIALE ROW ...... <br>"
                html += "<pre>" + print_r_py(row) + "</pre>"
            ...
            html += "No se encontraron registros en la tabla Vehiculo."
    ...
    def get_detail_vehiculo(self, id):
        ...
        <table border="1" align="center">
            ...
            <tr><td>Valor Matrícula:</td>
                <th>${self._calculo_matricula(row['avaluo'])} USD</th></tr>
            <tr><td>Foto:</td>
                <td><img src="/imagenes/{row['foto']}" width="200px"></td></tr>
            <tr><th colspan="2"><a href="/">Regresar</a></th></tr>
        </table>
        """
        return html
    ...
    def _message_BD_Vacia(self, tipo):
        return f"""
        <table border="0" align="center">
            <tr><th> NO existen registros en la {tipo}</th></tr>
        </table>
        """
